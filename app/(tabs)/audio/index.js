 ...
 useEffect(() => {
  ...
  const saveRecordingToStorage = async () => {
    ...
    try {
      ...
      const updatedRecordings = storedRecordings ? JSON.parse(storedRecordings) : [];
        ...
        <View style={styles.recordingContainer}>
          ...
          {isRecordingStartedMode ? (
            <View>
              ...
              <Image
              source={require("../../../assets/images/wave_audio.png")} // Replace with your arrow image path
              style={styles.doneButtonImage}
            />
              <Text style={styles.timerText}>{formatTime(timer)}</Text>
              <TouchableOpacity style={styles.doneButton} onPress={handleStopRecording}>
              <Image
              source={require("../../../assets/images/done_button.png")} // Replace with your arrow image path
              style={styles.doneButtonImage}
            />
              </TouchableOpacity>
            ...
            <View style={styles.centeredContent}>
              <TouchableOpacity onPress={handleStartRecording}>
                <Image
                  source={require("../../../assets/images/green_mic.png")} 
                  style={styles.image}
                />
              </TouchableOpacity>
        ...
        <View style={styles.libraryContainer}>
          ...
          {storedRecordings.map((file, index) => (
            ...
            <View style={styles.audioItem} key={index}>
              ...
              <TouchableOpacity onPress={() => playAudioinList(file.uri)} style={styles.playBtn}>
                <Image source={require("../../../assets/images/play.png")} style={styles.playBtnImage} />
              </TouchableOpacity>
            </View>
  ...
  <View style={styles.modalContainer}>
    ...
    <Image source={require("../../../assets/images/audio_main.png")}  />
    
    </View>
    <Text style={styles.subtitle}>Audio Generated!</Text>
    {isPlayIcon ? (
    <TouchableOpacity onPress={playAudio} style={styles.playPauseButton}>
...
<Text style={styles.timer}>
  {`${Math.floor(playbackTime / 60)}:${String(Math.floor(playbackTime % 60)).padStart(2, '0')} / ${Math.floor(timer / 60)}:${String(Math.floor(timer % 60)).padStart(2, '0')}`}
</Text>

    <TouchableOpacity onPress={saveRecordingToStorage} style={styles.saveButton}>
